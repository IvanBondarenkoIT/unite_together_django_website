...
urlpatterns = [
    ...
    path("<str:lang>/accounts/activate/<uidb64>/<token>/", views.activate, name="activate_en"),
    ...
    path(
        "<str:lang>/accounts/forgotPassword/", views.forgot_password, name="forgot_password_en"
    ),
    path(
    ...
    path("<str:lang>/accounts/reset_password/", views.reset_password, name="reset_password_en"),
]
